...
url_search = "http://aleph_alpha_rag:8001/semantic/search"
url_qa = "http://aleph_alpha_rag:8001/explanation/explain-qa"


logger.info("Starting Application.")

# Set small icon in the tab bar
st.set_page_config(page_title="Conversational aleph_alpha_rag", page_icon=":rocket:", layout="wide")
